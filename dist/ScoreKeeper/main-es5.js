...
var ScoreboardComponent = /** @class */ (function () {
    ...
    ScoreboardComponent.prototype.sortPlayersByScore = function () {
        console.log('About to sort');
        this.players = this.players.sort(_player__WEBPACK_IMPORTED_MODULE_2__["Player"].getComparatorScores());
    };
    ScoreboardComponent.prototype.addPlayer = function () {
        var createdPlayer = new _player__WEBPACK_IMPORTED_MODULE_2__["Player"]();
        createdPlayer.setName('NewPlayer');
        this.players.push(createdPlayer);
    };
    ScoreboardComponent.prototype.deletePlayer = function (i) {
        console.log('i is ' + i);
        this.players.splice(Number(i), 1);
    };
    ScoreboardComponent.prototype.gotCall = function (i) {
        var player = this.players[i];
        player.score = Number(player.score) + Number(player.getBid()) + Number(10);
    };
    ScoreboardComponent.prototype.gotJeopardyCall = function (i) {
        var player = this.players[i];
        player.score = Number(player.score) + Number(player.wager);
    };
    ScoreboardComponent.prototype.missJeopardyCall = function (i) {
        var player = this.players[i];
        player.score = Number(player.score) - Number(player.wager);
    };
    ScoreboardComponent.prototype.debugPlayers = function () {
        console.log(this.players);
    };
    ScoreboardComponent.prototype.changeRound = function (dir) {
        var e_1, _a;
        if (dir == 'plus') {
        ...
        try {
            // reset bids
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.players), _c = _b.next(); !_c.done; _c = _b.next()) {
                var p = _c.value;
                p.bid = null;
            }
        }
    ...
    ScoreboardComponent.prototype.toggleJeopardyMode = function () {
    ...
    ScoreboardComponent.prototype.toggleWagerInput = function (event, i) {
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.setBid = function (n) {
        this.bid = n;
    };
    ...
    Player.prototype.setWagerClassName = function (n) {
        this.wagerClassName = n;
    };
    Player.getComparatorScores = function () {
        return function (a, b) {
